...
class ReviewService:
    ...
    async def list_reviews(
        ...
        if filters.pull_request_user_id:
            conditions.append(PullRequestReview.pull_request_user_id == filters.pull_request_user_id)
    ...
    async def update_review(
        ...
        if update_data.pull_request_status and update_data.pull_request_status != review.pull_request_status:
    ...
    async def get_review_statistics(
        ...
        status_query = select(
            PullRequestReview.pull_request_status,
        ...
        avg_score_query = select(
            func.avg(PullRequestReview.score)
        ).select_from(base_query.subquery())
