...
class ProjectStats(BaseModel):
    ...
    total_repositories: int = Field(..., description="Total number of repositories across all projects")
...
class ProjectFilter(BaseModel):
    ...
    date_from: Optional[datetime] = Field(None, description="Filter projects created after this date")
    date_to: Optional[datetime] = Field(None, description="Filter projects created before this date")
