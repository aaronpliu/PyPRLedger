...
async def get_projects_with_most_reviews(
    ...
    try:
        ...
        metrics.increment_error(
            error_type="INTERNAL_SERVER_ERROR",
            endpoint="GET /api/v1/projects/top/reviews"
        )
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail={
...
async def get_projects_with_most_active_reviewers(
    ...
    try:
        ...
        metrics.increment_error(
            error_type="INTERNAL_SERVER_ERROR",
            endpoint="GET /api/v1/projects/top/reviewers"
        )
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail={
    ...
    try:
        ...
        if not project:
            metrics.increment_error(
                ...
                endpoint=f"GET /api/v1/projects/{project_id}"
            )
            raise HTTPException(
...
async def get_project_by_project_id(
    ...
    try:
        ...
        if not project:
            metrics.increment_error(
                error_type="NOT_FOUND",
                endpoint=f"GET /api/v1/projects/id/{project_id}"
            )
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail={
...
async def get_project_by_key(
    ...
    try:
        ...
        if not project:
            metrics.increment_error(
                error_type="NOT_FOUND",
                endpoint=f"GET /api/v1/projects/key/{project_key}"
            )
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail={
        ...
        raise HTTPException(
            ...
            detail={
                "error": "INTERNAL_SERVER_ERROR",
                "message": "Failed to get project by key"
            }
        )
...
async def get_project_by_name(
    ...
    try:
        ...
        if not project:
            metrics.increment_error(
                error_type="NOT_FOUND",
                endpoint=f"GET /api/v1/projects/name/{project_name}"
            )
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail={
        ...
        raise HTTPException(
            ...
            detail={
                "error": "INTERNAL_SERVER_ERROR",
                "message": "Failed to get project by name"
            }
        )
...
async def update_project(
    ...
    try:
        ...
        metrics.increment_error(
            error_type=e.code,
            endpoint=f"PUT /api/v1/projects/{project_id}"
        )
        raise HTTPException(
            status_code=e.status_code,
            detail={
...
async def delete_project(
    ...
    try:
        ...
        if not deleted:
            metrics.increment_error(
                error_type="NOT_FOUND",
                endpoint=f"DELETE /api/v1/projects/{project_id}"
            )
            raise HTTPException(
                status_code=status.HTTP_404_NOT_FOUND,
                detail={
...
async def get_project_repository_count(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail={
                "error": "INTERNAL_SERVER_ERROR",
                "message": "Failed to get repository count"
            }
        )
