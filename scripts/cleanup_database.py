...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Clean up the entire database by dropping all tables',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Use database URL from .env file (recommended)
  python scripts/cleanup_database.py
  
  # The script will automatically load DATABASE_URL from:
