...
Configurable rule-based auto-assignment of reviewers to pull request reviews, with priority-based matching, multi-project/repo/user conditions, temporal control, and enable/disable toggling.
...
- **THEN** both Alice and Bob get `PullRequestReviewAssignment` records with `assignment_status = "pending"`
