...
All Auth User (system login user) management operations are accessible under the `/api/v1/users/auth/` path prefix with the path parameter named `auth_user_id`.
