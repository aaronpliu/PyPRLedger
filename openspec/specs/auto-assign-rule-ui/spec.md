...
Browser-based management of auto-assignment rules for review admins, including rule listing, creation, editing, enable/disable toggling, and deletion — integrated into the existing Task Assignment area.
...
The system SHALL provide a "Create Rule" button that opens a dialog with form fields for name, description, priority, conditions, assign-to, max assignments, starts_at, expires_at, and is_active toggle.
